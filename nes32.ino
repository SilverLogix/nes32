...
// esp_8_bit
// NES game consoles on your TV with nothing more than a ESP32 and a sense of nostalgia
...
#else
//Use ESP spiffs
  printf("\n\n\nesp_8_bit\n\nmounting spiffs (will take ~5 seconds if formatting for the first time)....\n");
  uint32_t t = millis();
